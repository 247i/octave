...
#define OCTAVE_VERSION "4.4.1"

#define OCTAVE_MAJOR_VERSION 4
...
#define OCTAVE_API_VERSION "api-v52"

#define OCTAVE_RELEASE_DATE "2018-08-09"

#define OCTAVE_COPYRIGHT "Copyright (C) 2018 John W. Eaton and others."
