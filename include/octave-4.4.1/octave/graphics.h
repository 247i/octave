...
public:
  ...
  enum
  {
    ...
    ID_WINDOWSTYLE = 2045,
    ID_PICKABLEPARTS = 2046,
    ID___GL_EXTENSIONS__ = 2047,
    ID___GL_RENDERER__ = 2048,
    ID___GL_VENDOR__ = 2049,
    ID___GL_VERSION__ = 2050,
    ID___GL_WINDOW__ = 2051,
    ID___GRAPHICS_TOOLKIT__ = 2052,
    ID___GUIDATA__ = 2053,
    ID___MOUSE_MODE__ = 2054,
    ID___PRINTING__ = 2055,
    ID___PAN_MODE__ = 2056,
    ID___PLOT_STREAM__ = 2057,
    ID___ROTATE_MODE__ = 2058,
    ID___ZOOM_MODE__ = 2059,
    ID_DOUBLEBUFFER = 2060,
    ID_MINCOLORMAP = 2061,
    ID_WVISUAL = 2062,
    ID_WVISUALMODE = 2063,
    ID_XDISPLAY = 2064,
  ...
  bool is___gl_window__ (void) const { return __gl_window__.is_on (); }
  std::string get___gl_window__ (void) const { return __gl_window__.current_value (); }
  ...
  bool is___printing__ (void) const { return __printing__.is_on (); }
  std::string get___printing__ (void) const { return __printing__.current_value (); }
  ...
  {
    warning_with_id ("Octave:deprecated-property","'doublebuffer' is deprecated and will be removed from a future version of Octave");
    return doublebuffer.current_value ();
  }

  double get_mincolormap (void) const
  {
    warning_with_id ("Octave:deprecated-property","'mincolormap' is deprecated and will be removed from a future version of Octave");
    return mincolormap.double_value ();
  }

  std::string get_wvisual (void) const
  {
    warning_with_id ("Octave:deprecated-property","'wvisual' is deprecated and will be removed from a future version of Octave");
  ...
  {
    warning_with_id ("Octave:deprecated-property","'wvisualmode' is deprecated and will be removed from a future version of Octave");
    return wvisualmode.current_value ();
  }

  std::string get_xdisplay (void) const
  {
    warning_with_id ("Octave:deprecated-property","'xdisplay' is deprecated and will be removed from a future version of Octave");
    return xdisplay.string_value ();
  }

  std::string get_xvisual (void) const
  {
    warning_with_id ("Octave:deprecated-property","'xvisual' is deprecated and will be removed from a future version of Octave");
  ...
  {
    warning_with_id ("Octave:deprecated-property","'xvisualmode' is deprecated and will be removed from a future version of Octave");
    return xvisualmode.current_value ();
  }
...
private:
  ...
  row_vector_property cameraposition;
  radio_property camerapositionmode;
  row_vector_property cameratarget;
  radio_property cameratargetmode;
  row_vector_property cameraupvector;
  ...
  array_property currentpoint;
  row_vector_property dataaspectratio;
  ...
  radio_property nextplot;
  array_property outerposition;
  row_vector_property plotboxaspectratio;
  ...
  array_property __colormap__;
  double_property mousewheelzoom;
  radio_property __autopos_tag__;
  array_property looseinset;
  row_vector_property xminortickvalues;
  row_vector_property yminortickvalues;
  row_vector_property zminortickvalues;
  double_property __fontsize_points__;
...
public:
  ...
  enum
  {
    ...
    ID_COLORMAP = 3018,
    ID_COLORORDER = 3019,
    ID_COLORORDERINDEX = 3020,
    ID_CURRENTPOINT = 3021,
    ID_DATAASPECTRATIO = 3022,
    ID_DATAASPECTRATIOMODE = 3023,
    ID_DRAWMODE = 3024,
    ID_FONTANGLE = 3025,
    ID_FONTNAME = 3026,
    ID_FONTSIZE = 3027,
    ID_FONTUNITS = 3028,
    ID_FONTSMOOTHING = 3029,
    ID_FONTWEIGHT = 3030,
    ID_GRIDALPHA = 3031,
    ID_GRIDALPHAMODE = 3032,
    ID_GRIDCOLOR = 3033,
    ID_GRIDCOLORMODE = 3034,
    ID_GRIDLINESTYLE = 3035,
    ID_LABELFONTSIZEMULTIPLIER = 3036,
    ID_LAYER = 3037,
    ID_LINESTYLEORDER = 3038,
    ID_LINESTYLEORDERINDEX = 3039,
    ID_LINEWIDTH = 3040,
    ID_MINORGRIDALPHA = 3041,
    ID_MINORGRIDALPHAMODE = 3042,
    ID_MINORGRIDCOLOR = 3043,
    ID_MINORGRIDCOLORMODE = 3044,
    ID_MINORGRIDLINESTYLE = 3045,
    ID_NEXTPLOT = 3046,
    ID_OUTERPOSITION = 3047,
    ID_PLOTBOXASPECTRATIO = 3048,
    ID_PLOTBOXASPECTRATIOMODE = 3049,
    ID_POSITION = 3050,
    ID_PROJECTION = 3051,
    ID_SORTMETHOD = 3052,
    ID_TICKDIR = 3053,
    ...
    ID_ZTICKMODE = 3109,
    ID___COLORMAP__ = 3110,
    ID_MOUSEWHEELZOOM = 3111,
    ID___AUTOPOS_TAG__ = 3112,
    ID_LOOSEINSET = 3113,
    ID_XMINORTICKVALUES = 3114,
    ID_YMINORTICKVALUES = 3115,
    ID_ZMINORTICKVALUES = 3116,
    ID___FONTSIZE_POINTS__ = 3117
  };
  ...
  {
    warning_with_id ("Octave:deprecated-property","'drawmode' is deprecated and will be removed from a future version of Octave");
  ...
  octave_value get___colormap__ (void) const { return __colormap__.get (); }

  double get_mousewheelzoom (void) const { return mousewheelzoom.double_value (); }

  bool __autopos_tag___is (const std::string& v) const { return __autopos_tag__.is (v); }
  std::string get___autopos_tag__ (void) const { return __autopos_tag__.current_value (); }

  octave_value get_looseinset (void) const { return looseinset.get (); }

  octave_value get_xminortickvalues (void) const { return xminortickvalues.get (); }

  octave_value get_yminortickvalues (void) const { return yminortickvalues.get (); }

  octave_value get_zminortickvalues (void) const { return zminortickvalues.get (); }
  ...
  {
    if (__autopos_tag__.set (val, true))
      {
        mark_modified ();
      }
  }
  ...
  {
    if (xminortickvalues.set (val, true))
      {
        mark_modified ();
      }
  }
  ...
  {
    if (yminortickvalues.set (val, true))
      {
        mark_modified ();
      }
  }
  ...
  {
    if (zminortickvalues.set (val, true))
      {
        mark_modified ();
      }
  }
  ...
  {
    if (__fontsize_points__.set (val, true))
      {
        mark_modified ();
      }
  }
...
public:
  ...
  enum
  {
    ...
    ID_LINEWIDTH = 4006,
    ID_MARKER = 4007,
    ID_MARKEREDGECOLOR = 4008,
    ID_MARKERFACECOLOR = 4009,
    ID_MARKERSIZE = 4010,
    ID_XDATA = 4011,
    ID_XDATASOURCE = 4012,
    ID_YDATA = 4013,
  ...
  {
    warning_with_id ("Octave:deprecated-property","'interpreter' is deprecated and will be removed from a future version of Octave");
    return interpreter.current_value ();
  }

  bool linejoin_is (const std::string& v) const { return linejoin.is (v); }
  std::string get_linejoin (void) const { return linejoin.current_value (); }
...
private:
  ...
  string_property __fltk_label__;
...
public:
  ...
  enum
  {
    ID_ACCELERATOR = 11000,
    ID_CALLBACK = 11001,
    ID_CHECKED = 11002,
    ID_ENABLE = 11003,
    ID_FOREGROUNDCOLOR = 11004,
    ID_LABEL = 11005,
    ID_POSITION = 11006,
    ID_SEPARATOR = 11007,
    ID___FLTK_LABEL__ = 11008,
    ID___OBJECT__ = 11009
  };
  ...
  std::string get___fltk_label__ (void) const { return __fltk_label__.string_value (); }
  ...
  {
    if (__fltk_label__.set (val, true))
      {
        mark_modified ();
      }
  }
...
public:
  ...
  enum
  {
    ...
    ID_FONTUNITS = 13009,
    ID_FONTWEIGHT = 13010,
    ID_FOREGROUNDCOLOR = 13011,
    ID_HORIZONTALALIGNMENT = 13012,
    ID_KEYPRESSFCN = 13013,
    ID_LISTBOXTOP = 13014,
    ID_MAX = 13015,
    ID_MIN = 13016,
    ID_POSITION = 13017,
    ...
    ID_STRING = 13019,
    ID_STYLE = 13020,
    ID_TOOLTIPSTRING = 13021,
    ID_UNITS = 13022,
    ID_VALUE = 13023,
    ID_VERTICALALIGNMENT = 13024,
    ID___OBJECT__ = 13025
  };
...
public:
  ...
  enum
  {
    ...
    ID_FONTUNITS = 14007,
    ID_FONTWEIGHT = 14008,
    ID_FOREGROUNDCOLOR = 14009,
    ID_HIGHLIGHTCOLOR = 14010,
    ID_POSITION = 14011,
    ID_RESIZEFCN = 14012,
    ID_SELECTEDOBJECT = 14013,
    ID_SELECTIONCHANGEDFCN = 14014,
    ID_SHADOWCOLOR = 14015,
    ID_SIZECHANGEDFCN = 14016,
    ID_UNITS = 14017,
    ID_TITLE = 14018,
    ID_TITLEPOSITION = 14019,
    ID___OBJECT__ = 14020
  };
...
public:
  ...
  enum
  {
    ...
    ID_FONTUNITS = 15006,
    ID_FONTWEIGHT = 15007,
    ID_FOREGROUNDCOLOR = 15008,
    ID_HIGHLIGHTCOLOR = 15009,
    ID_POSITION = 15010,
    ID_RESIZEFCN = 15011,
    ID_SHADOWCOLOR = 15012,
    ID_TITLE = 15013,
    ID_TITLEPOSITION = 15014,
    ID_UNITS = 15015,
    ID___OBJECT__ = 15016
  };
...
public:
  ...
  {
    ID_CDATA = 17000,
    ID_CLICKEDCALLBACK = 17001,
    ID_ENABLE = 17002,
    ID_SEPARATOR = 17003,
    ID_TOOLTIPSTRING = 17004,
    ID___OBJECT__ = 17005
  };
...
public:
  ...
  {
    ID_CDATA = 18000,
    ID_CLICKEDCALLBACK = 18001,
    ID_ENABLE = 18002,
    ID_OFFCALLBACK = 18003,
    ID_ONCALLBACK = 18004,
    ID_SEPARATOR = 18005,
    ID_STATE = 18006,
    ID_TOOLTIPSTRING = 18007,
    ID___OBJECT__ = 18008
  };
